...
This adds extra columns for revised and rescheduled, adds html tags (<p> & </p>) to the synopsis, reformats the date and rearranges columns.
...
Publications that have been rescheduled need two entries in the list to ensure that they appear at the original and new dates. The new date will be in the procxed output, but the original date needs added back in. The this is added to the new_pubs object using `bind_rows()`
